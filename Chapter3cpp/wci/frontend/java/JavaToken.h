...
{
    // Reserved words.
    ABSTRACT, DOUBLE, INT, LONG, BREAK, ELSE, SWITCH, CASE, ENUM, NATIVE, SUPER, 
    CHAR, EXTENDS, RETURN, THIS, CLASS, FLOAT, SHORT, THROW, CONST, FOR, PACKAGE, VOID,
...
constexpr JavaTokenType PT_RETUEN = JavaTokenType::RETURN;
...
constexpr JavaTokenType PT_PROGRAM = JavaTokenType::CONTINUE;
constexpr JavaTokenType PT_RECORD = JavaTokenType::GOTO;
constexpr JavaTokenType PT_REPEAT = JavaTokenType::PROTECTED;
constexpr JavaTokenType PT_SET = JavaTokenType::VOLATILE;
constexpr JavaTokenType PT_THEN = JavaTokenType::DO;
constexpr JavaTokenType PT_TO = JavaTokenType::IF;
constexpr JavaTokenType PT_TYPE = JavaTokenType::STATIC;
...
constexpr JavaTokenType PT_SEMI_COLON = JavaTokenType::SEMI_COLON;
...
constexpr JavaTokenType PT_QUOTATION = JavaTokenType::QUOTATION;
...
constexpr JavaTokenType PT_BIT_LEFT = JavaTokenType::BIT_LEFT;
...
constexpr JavaTokenType PT_LINE_COMMENT = JavaTokenType::LINE_COMMENT;
